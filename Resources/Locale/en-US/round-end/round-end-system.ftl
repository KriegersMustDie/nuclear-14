...
round-end-system-shuttle-called-announcement = An emergency train has been sent. ETA: {$time} {$units}.
#round-end-system-shuttle-already-called-announcement = An emergency shuttle has already been sent.
round-end-system-shuttle-already-called-announcement = An emergency train has already been sent.
...
round-end-system-shuttle-auto-called-announcement = An automatic crew shift change train has been sent. ETA: {$time} {$units}. Recall the train to extend the shift.
#round-end-system-shuttle-recalled-announcement = The emergency shuttle has been recalled.
round-end-system-shuttle-recalled-announcement = The emergency train has been recalled.
