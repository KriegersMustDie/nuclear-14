...
call-shuttle-command-description = Calls the emergency train with an optionally provided arrival time.
call-shuttle-command-help-text = Usage: {$command} [m:ss]
#recall-shuttle-command-description = Recalls the emergency shuttle.
recall-shuttle-command-description = Recalls the emergency train.
